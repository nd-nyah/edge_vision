...
class Detector:
    def __init__(self, YOLOV5_MODEL_PATH, YOLO_WORLD_MODEL_PATH):
        ...
        # YOLO-World
        # =========================
        self.world_model = YOLO(YOLO_WORLD_MODEL_PATH)
...
#         # =========================
#         # YOLO-WORLD (REPLACED WITH ONNX)
#         # =========================
#         self.world_model = ort.InferenceSession(
#             yoloworld_path,
#             providers=["CPUExecutionProvider"]
#         )
#         self.world_input_name = self.world_model.get_inputs()[0].name

#     # =========================
#     # PROMPTS (UNCHANGED API)
#     # =========================
#     def set_prompts(self, prompts):
#         self.text_prompts = prompts or []
...
#     # =========================
#     # YOLO-WORLD (NOW FAKE BUT API SAME)
#     # =========================
#     def _predict_yoloworld(self, frame):

#         input_tensor = self.preprocess(frame)
#         outputs = self.world_model.run(None, {self.world_input_name: input_tensor})
#         preds = np.squeeze(outputs[0])

#         detections = []

#         allowed = set([p.lower() for p in self.text_prompts])
...
#             # 🔥 THIS REPLACES YOLO-WORLD set_classes()
